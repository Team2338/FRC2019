...
public abstract class RobotMap {
    ...
    public static final int FRONT_LEFT_REVERSE_ID = 0;
    public static final int REAR_LEFT_FORWARD_ID = 7;
    public static final int REAR_LEFT_REVERSE_ID = 6;
    public static final int FRONT_RIGHT_FORWARD_ID = 3;
    public static final int FRONT_RIGHT_REVERSE_ID = 2;
    public static final int REAR_RIGHT_FORWARD_ID = 5;
    public static final int REAR_RIGHT_REVERSE_ID = 4;
