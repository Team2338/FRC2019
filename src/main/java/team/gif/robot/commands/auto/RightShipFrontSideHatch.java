...
public class RightShipFrontSideHatch extends CommandGroup {
    ...
    private final Trajectory finalApproach = Pathfinder.generate(new Waypoint[] {
            ...
            TargetPosition.RIGHT_SHIP_NEAR.getRobotWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 4 - 4, 0, false)
    }, Constants.Drivetrain.slowConfig);

    public RightShipFrontSideHatch() {
