...
public class RightShipSideHatch extends CommandGroup {

    private final Trajectory reverseApproach = Pathfinder.generate(new Waypoint[] {
            AutoPosition.L1_RIGHT.getRobotWaypoint(0.0),
            AutoPosition.L1_RIGHT.getRobotWaypoint(48.275),
            TargetPosition.RIGHT_SHIP_NEAR.getRelativeWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 48, -48 - 9, 0.0),
            TargetPosition.RIGHT_SHIP_NEAR.getRobotWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2, -9, false)
    ...
    private final Trajectory loadingStation = Pathfinder.generate(new Waypoint[] {
            ...
            TargetPosition.RIGHT_SHIP_NEAR.getRelativeWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 48, -48, Math.toRadians(180)),
            TargetPosition.RIGHT_LOADING_STATION.getRobotWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 24 - 4, -6, false),
            TargetPosition.RIGHT_LOADING_STATION.getRobotWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 4 - 4, -6, false)
    ...
    private final Trajectory reverseReturn = Pathfinder.generate(new Waypoint[] {
            ...
            TargetPosition.RIGHT_SHIP_FRONT.getRelativeWaypoint(-Constants.Drivetrain.BUMPER_WIDTH - 36, 48, Math.toRadians(90))
    }, Constants.Drivetrain.fastConfig);

    private final Trajectory finalApproach = Pathfinder.generate(new Waypoint[] {
            TargetPosition.RIGHT_SHIP_FRONT.getRelativeWaypoint(-Constants.Drivetrain.BUMPER_WIDTH - 60, 48, Math.toRadians(-90)),
            TargetPosition.RIGHT_ROCKET_NEAR.getRobotWaypoint(-Constants.Drivetrain.BUMPER_LENGTH / 2 - 72, 0, false),
